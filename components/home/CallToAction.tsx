        ...
        >
          ...
          <div className="relative z-10">
            ...
            <p className="text-gray-300 text-lg leading-relaxed max-w-xl mx-auto mb-10">
              Every project starts with a conversation. Let's discuss your situation and figure
              out exactly where expert consulting can make the biggest difference for you.
            </p>
